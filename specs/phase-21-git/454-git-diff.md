...
Implement Git diff functionality, providing structured access to file changes between commits, index, and working directory.
...
### 2. Diff Implementation (src/diff_impl.rs)
...
1. Diff detects all change types
2. Hunks are correctly parsed
3. Rename detection works
4. Binary files are handled
...
- Depends on: [453-git-status.md](453-git-status.md)
- Next: [455-git-commit.md](455-git-commit.md)
