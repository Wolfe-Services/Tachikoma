...
- [ ] Implement `LlmProvider::complete()` for non-streaming
- [ ] Export `AnthropicProvider` from `llm/mod.rs`
- [ ] Write a test that mocks the API response (don't call real API in tests)
