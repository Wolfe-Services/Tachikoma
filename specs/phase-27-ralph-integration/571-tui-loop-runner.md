...
- [x] Implement TUI using `ratatui` crate
- [x] Left panel: Task/spec list with status indicators (✓ → ○)
- [x] Right panel: Live streaming agent output
- [x] Bottom bar: Keyboard shortcuts
- [x] Progress bar showing spec/criteria completion
- [x] Token usage gauge with redline indicator
- [x] Cost tracking display
- [x] Keyboard controls: p(pause), d(dashboard), q(quit), ?(help)
- [x] Support for resizable panes
- [x] History scrollback in output panel
