...
- [x] Define "simple" config schema with ~10 essential options
- [x] Auto-expand simple config to full config at runtime
- [x] Add `config_mode: simple | full` field
- [x] Create migration from simple → full when user adds advanced options
- [x] Update `tachikoma init` to generate simple config by default
- [x] Add `tachikoma config upgrade` to convert simple → full
