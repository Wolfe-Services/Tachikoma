...
- [ ] Define plugin trait interface for agents
- [ ] Define plugin trait interface for trackers
- [ ] Create `.tachikoma/plugins/` directory structure
- [ ] Support plugin discovery and loading at startup
- [ ] Add `--agent` CLI flag for runtime agent selection
- [ ] Add `--tracker` CLI flag for tracker selection
