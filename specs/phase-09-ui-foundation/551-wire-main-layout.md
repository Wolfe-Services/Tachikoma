...
## Acceptance Criteria
- [x] Main layout component shows sidebar navigation
- [x] Default route shows Dashboard or Mission Panel
- [x] Navigation works between Dashboard, Specs, Forge, Settings
- [x] Sidebar can collapse/expand
- [x] Theme (dark/light) applies consistently
- [x] All existing components are accessible via navigation
