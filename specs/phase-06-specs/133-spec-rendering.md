# Spec 133: Spec Template Rendering

## Metadata
- **Phase**: 6 - Spec System (THE PIN)
- **Spec ID**: 133
- **Status**: Planned
- **Dependencies**: 117-spec-templates, 120-spec-parsing
- **Estimated Context**: ~10%

## Objective

Implement a template rendering system that generates spec documents and related artifacts from templates. The rendering system supports multiple output formats, dynamic content insertion, conditional sections, and integration with spec metadata for context-aware generation.
...
- **117-spec-templates.md**: Templates this renders
- **119-readme-autogen.md**: README generation uses rendering
- **134-spec-conversation.md**: Conversational generation
