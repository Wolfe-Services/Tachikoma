# 158 - Forge Prompt Templates

**Phase:** 7 - Spec Forge Multi-Model Brainstorming
**Spec ID:** 158
**Status:** Planned
**Dependencies:** 137-forge-config, 140-round1-draft
...
Implement a prompt template system for Forge that allows customization of prompts for different round types, output types, and use cases while maintaining consistency.
...
### 1. Template Engine (src/templates/engine.rs)
...
use crate::{ForgeError, ForgeResult, OutputType, ParticipantRole};
...
1. Built-in templates render correctly
2. Variable substitution works
3. Conditional blocks evaluate properly
4. Fragment inclusion works
5. Missing required vars caught
6. Custom templates can be loaded
...
- Next: [159-forge-validation.md](159-forge-validation.md)
- Used by: All round implementations (140-145)
