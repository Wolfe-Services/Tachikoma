...
complete -c tachikoma -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from list edit path init' -a set -d 'Set a value'
complete -c tachikoma -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from get set edit path init' -a list -d 'List all'
complete -c tachikoma -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from get set list path init' -a edit -d 'Edit config'
complete -c tachikoma -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from get set list edit init' -a path -d 'Show config path'
complete -c tachikoma -n '__fish_seen_subcommand_from config; and not __fish_seen_subcommand_from get set list edit path' -a init -d 'Initialize config'
